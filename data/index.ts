...
export const gridItems = [
  {
    ...
    img: "https://static.vecteezy.com/system/resources/thumbnails/003/042/243/small/abstract-blue-grunge-texture-background-free-vector.jpg",
  },
  {
    id: 2,
    title: "The cooking tools I use",
    description: "",
  ...
  },
  {
    ...
    imgClassName: "w-full h-full",
    titleClassName: "justify-end",
    img: "https://www.shutterstock.com/image-photo/dark-purple-noisy-blurred-gradient-600nw-2372985175.jpg",
  },
  {
    id: 4,
    title: "",
  ...
  {
    id: 5,
    title: "What are you having, sir?",
    description: "Mail the Chef for a quick lunch",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "w-full h-full",
    titleClassName: "justify-end",
    img: "",
...
export const projects = [
  ...
  },
  {
    ...
    content: 'This is the work/food that I enjoy/savour every byte/bite (Okay I will STOP!). I love explaining things that I understand. Especially infront of a live audience as it allows me to better grasp what parts are flying above their heads. I love to see the knots untangling in their brain and the Light bulb moment that slowly lits up on their faces. So, I am making videos explaining topics. Although I love/need constant feedbacks; kinda like a trial & error thingy (my explaination runs on feedbacks). But you can still give these Vidsplainers a try.'
  },
];
